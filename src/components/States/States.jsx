...
const States = () => {
    return (
        <div>
            {/* states  */}
            <div className='flex flex-col items-center py-14 bg-linear-to-tr from-purple-700 to-purple-400 text-center text-white'>
                <h3 className='text-4xl md:py-8 font-bold '>Trusted By Millions, Built For You</h3>
