            ...
            <div className="navbar-start">
                <div className="dropdown">
                    ...
                    <ul
                        ...
                        <li><NavLink to={'/'} className={({ isActive }) => isActive ? 'border-b-2 rounded-none border-purple-500 text-purple-600' : 'undefined'}>Home</NavLink></li>
                        <li><NavLink to={'/apps'} className={({ isActive }) => isActive ? 'border-b-2 rounded-none border-purple-500 text-purple-600' : 'undefined'}>Apps</NavLink ></li>
                        <li><NavLink to={'/installation'} className={({ isActive }) => isActive ? 'border-b-2 rounded-none border-purple-500 text-purple-600' : 'undefined'}>Installation</NavLink></li>
                    </ul>
                </div>
